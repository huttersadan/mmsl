...
def start_inference(opt=None):
    ...
    test_vid_dataset = VisDataSet4MS_SL(opt.root_path,opt.visual_feature,opt.collection, opt,
                                               video_ids=test_video_ids_list)
    test_text_dataset = TxtDataSet4MS_SL(opt.root_path,opt.visual_feature,opt.collection, opt)
